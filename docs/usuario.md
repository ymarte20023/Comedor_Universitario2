...
Bienvenido al Manual de Usuario del **Sistema de Control de Inventario**.

Este documento le guiará a través de todas las funcionalidades del sistema según su rol asignado.
